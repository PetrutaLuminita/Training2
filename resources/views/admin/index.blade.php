        ...
        <?php else: ?>
            ...
            <tr>
                ...
                <td class="text-center align-middle">
                    <a href="{{ route('admin.products.edit', ['product' => $product]) }}" class="btn btn-primary">{{ __('Edit') }}</a>
                    <a href="{{ route('admin.products.delete', ['product' => $product]) }}" class="btn btn-primary">{{ __('Delete') }}</a>
                </td>
            </tr>
            <?php endforeach ?>
        <?php endif ?>
